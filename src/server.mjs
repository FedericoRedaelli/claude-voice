...
server.registerTool(
  "talk_to_user",
  {
    ...
    description:
      ...
      'An "end" may carry a `note` explaining that the call never opened (usually: no browser ' +
      "tab is attached) — show that note to the user verbatim, it contains the URL they need.",
    inputSchema: {
      message: z
        .string()
